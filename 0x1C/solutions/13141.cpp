// Authored by : jkl
// Co-authored by : -
// http://boj.kr/f4b4371b42204ad3984e85124a268465
#include <bits/stdc++.h>
...
/*
  ...
  (1+2+3)/2 로 해당 간선이 불에 타는 최소시간을 구할 수 있다. (이해가 안갈 경우 X-A-B를 연결한 고무줄을 반으로 자른다고 생각해보자.)
  모든 간선이 불에 타는시간은 가장 긴 간선이 불에 타는 시간과 동일하다.
