...
// Co-authored by : -
// http://boj.kr/7086f3a909bc435ba3145f9a8d70034b
#include <bits/stdc++.h>
using namespace std;
...
알파벳 순서는 48번째 줄을 통해 부여되며,
0 이상, a.size() 미만의 값을 갖는다.
...
32-35번째 줄은 j == w.size()일 때 별도의 처리를 안 하면
다음 i에 대해서 j가 w의 마지막 문자(널문자)를 인덱싱하고,
이로 인해 segmentation_fault가 발생되기에
이에 대한 예외처리를 한 구문이다.
*/